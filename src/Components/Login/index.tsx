    ...
    <>
      <section className="login flex flex-col drop-shadow-2xl shadow-lg shadow-blue md:block md:max-w-sm md:mx-auto my-20">
        ...
        <form className='flex flex-col items-center gap-5'>
          <InputText type='email' value={email} name='email' placeholder='E-mail' changeField={setMail} />
          <InputText type='password' value={password} name='password' placeholder='Mot de passe' changeField={setPassword} />
