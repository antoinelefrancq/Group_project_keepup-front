  ...
  return (
    <div className="bg-greyPlaceholder rounded-lg w-full p-0.5 flex items-center">
      ...
      <div className="text-blue">
        ...
        <p className="px-1 text-[13px]">Activité: musculation <span className="bg-blue rounded-full text-greyPlaceholder text-[11px] p-1">Amateur</span></p>
        <p className="flex justify-start items-end gap-4 py-2 pr-3">
          <span className="bg-blue rounded-r-full text-greyPlaceholder text-[13px] p-1">1/2 place disponible</span>
