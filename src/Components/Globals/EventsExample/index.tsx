function EventsExample() {
  return (
    <div className="flex flex-col gap-5 top-8">
      ...
      <div className="bg-white rounded-lg w-full p-0.5 h-auto flex">
        <div className="bg-red rounded-l-lg flex items-center">
          <div className="flex flex-col align-center justify-center w-[66px]">
            <div className="text-white border-b-2 w-full text-center text-[15px] font-bold"><p>Jeu</p><p>22</p></div>
            <div className="flex justify-center">
              <svg width="30" height="50" viewBox="0 0 61 92" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M27.6108 17.2C32.3608 17.2 36.2108 13.35 36.2108 8.60001C36.2108 3.85001 32.3608 0 27.6108 0C22.8608 0 19.0107 3.85001 19.0107 8.60001C19.0107 13.35 22.8608 17.2 27.6108 17.2Z" fill="white"/>
                <path d="M16.8298 77.4986L5 78.3625" stroke="white" strokeWidth="10" strokeLinecap="round"/>
                <path d="M32.0001 28.3523L46.4375 38.464" stroke="white" strokeWidth="10" strokeLinecap="round"/>
                <path d="M14.0079 39.3523L28.4453 49.464" stroke="white" strokeWidth="10" strokeLinecap="round"/>
                <path d="M27.7666 44.0001L49.0166 86.0002" stroke="white" strokeWidth="10" strokeLinecap="round"/>
                <path d="M22.5728 51.9988L17.0029 77.0002" stroke="white" strokeWidth="10" strokeLinecap="round"/>
                <path d="M55.7236 27.0002L46.6934 38.4604" stroke="white" strokeWidth="10" strokeLinecap="round"/>
                <path d="M24.0572 27.281L14.3564 38.1796" stroke="white" strokeWidth="10" strokeLinecap="round"/>
                <path d="M28.0107 32L28.0107 46" stroke="white" strokeWidth="22" strokeLinecap="round"/>
              </svg></div>
          </div>
