        ...
        <div className="flex flex-col gap-5 absolute -top-8">
          ...
          <div className="bg-white rounded-lg w-full p-0.5 h-auto flex">
            ...
            <div className="text-blue">
              ...
              <p className="px-1 text-[13px]">Activité: marche rapide <span className="bg-orange rounded-full text-white text-[11px] p-1">Amateur</span></p>
              <p className="flex justify-start items-end gap-4 py-2 pr-3">
                <span className="bg-red rounded-r-full text-white text-[13px] p-2">1Complet</span>
                <span className="bg-blue rounded-full text-white text-[11px] px-2 py-1">10:00</span>
              </p>
            </div>
          </div>
        </div>    
