...
function Home() {
  return (
    <div className="bg-cover bg-no-repeat bg-top bg-home_mobile w-screen h-screen -m-[12px] relative sm:bg-home_desk">
      ...
      <div className="bg-vector bg-no-repeat flex flex-col items-center justify-center py-16 gap-20 vsm:hidden">
        <img src='./img/Arrow.svg' alt="flèche blanche" className="animate-bounce w-5 h-20"/>
        <p className="px-auto text-2xl text-center font-pangram text-white">C'est super simple tu vas voir, Rejoins une activité:</p>
      </div>
