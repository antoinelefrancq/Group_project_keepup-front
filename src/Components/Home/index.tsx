...
function Home() {
  return (
    <div className="bg-[length:1300px_650px] sm:bg-cover bg-no-repeat bg-top bg-home w-screen h-screen -m-[12px] relative">
      <section className="bg-opacity-20 bg-black sm:bg-transparent text-white pb-6 mb-15">
      ...
      <div className="flex align-center justify-center">
        <svg width="19" height="30" viewBox="0 0 19 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="animate-bounce w-5 h-20 bottom-32 absolute">
      ...
      <svg width="379" height="363" viewBox="0 0 379 363" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-screen">
